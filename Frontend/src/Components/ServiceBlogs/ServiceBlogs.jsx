...
const blogs = [
  ...
  },
  {
    ...
    image: ln5,
    description:
      "As climate concerns grow, our plates are becoming powerful tools for change through sustainable food choices.",
  ...
  },
  {
    ...
    image: ln4,
    description:
      "Artificial Intelligence is shaping routines—from smart homes to predictive healthcare—transforming how we live and work.",
    author: "John Carter",
    date: "Jul 05, 2025",
    comments: 124,
    views: 230,
  ...
  return (
    <section className="serviceblogs">
      ...
      <div className="serviceblogs-grid">
        {blogs.map((blog) => (
          <article className="serviceblogs-card" key={blog.id}>
            ...
            <div className="serviceblog-card-content">
