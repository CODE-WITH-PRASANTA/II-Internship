    ...
    <div className="noticepage-wrapper">
      ...
      <div className="noticepage-formPanel">
        ...
        <form className="noticepage-formBody" onSubmit={handleSubmit}>
          ...
          <button className="noticepage-submitBtn">Submit Notice</button>
        </form>
      </div>
            ...
            <tbody>
              {currentData.map((n, i) => (
                <tr key={n.id}>
                  ...
                  <td>
                    {n.image && <img src={n.image} className="noticepage-thumb" />}
                  </td>

                  <td>
                    <button className="editBtn" onClick={() => handleEdit(n)}>Edit</button>
                    <button className="deleteBtn" onClick={() => handleDelete(n.id)}>Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
